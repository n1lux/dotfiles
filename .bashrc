...
#xfce4
alias xfce4-terminal-tmux='xfce4-terminal --hide-borders --hide-scrollbar --fullscreen --hide-menubar -e tmux'
alias xfce4-terminal='xfce4-terminal --hide-borders --hide-menubar --hide-scrollbar --fullscreen'

#chrome alias
alias google-chrome='google-chrome --password-store=basic'
alias google-chrome-incognito='google-chrome -incognito'
